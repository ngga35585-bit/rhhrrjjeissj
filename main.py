...
# Variabile de Mediu (cu valori default dacă nu sunt setate)
...
# Configurații interne
MAX_CONCURRENT_SESSIONS = 15  # Număr de sesiuni paralele
USER_AGENTS = [
...
async def send_report(session, semaphore, stop_event, target_id, reason):
    ...
    async with semaphore:
        ...
        # Delay random mic pentru a imita comportament uman
...
async def main():
    logger.info("="*50)
    logger.info("   Discord Mass Report Script (Env Var Version)")
    logger.info("="*50)
